...
$('.mailchimp').ajaxChimp({
    ...
    url: "https://gmail.us3.list-manage.com/subscribe/post?u=877a5fedea739efb5863c91c6&amp;id=d0501ac209" //Replace this with your own mailchimp post URL. Don't remove the "". Just paste the url inside "".  
});
...
/* =================================
===  BANNER BUTTON CLICK SCROLL ==
=================================== */
jQuery(function( $ ){
			$('#button-banner').localScroll({
				duration:500
			});
		});
